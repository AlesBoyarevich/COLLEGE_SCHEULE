...
urlpatterns = [
    ...
    path('teachers/add/', views.TeachersCreate.as_view(), name='teachers create'),
    ...
    path('subjects/add/', views.SubjectsCreate.as_view(), name='subjects create'),
    ...
    path('groups/add/', views.GroupsCreate.as_view(), name='groups create'),
    ...
    path('schedule/add/', views.ScheduleCreate.as_view(), name='schedule create'),
